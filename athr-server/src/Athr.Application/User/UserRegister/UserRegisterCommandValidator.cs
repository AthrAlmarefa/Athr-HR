...
namespace Athr.Application.Users.UserRegister
{
    public sealed class UserRegisterCommandValidator : AbstractValidator<UserRegisterCommand>
    {
        public UserRegisterCommandValidator()
        {
            ...
            RuleFor(x => x.midName)
                .NotEmpty().WithMessage("Mid name is required.")
            ...
            .Must(BeValidIdentityType)
            .WithMessage("Invalid identity type.");
        }

        private bool BeValidIdentityType(string identityType)
        {
            return IdentityType.TryFromName(identityType, out _);
        }
    }
}
